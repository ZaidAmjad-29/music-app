...
import { 
  ...
  export default function AppLayout() {
    ...
    const links = [
      ...
      { to: "/playlists", label: "My Playlists", icon: Library, color: "text-pink-400" },
      { to: "/favorites", label: "Favorites", icon: Heart, color: "text-red-400" },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-6">
                ...
                {/* Profile Link */}
                <Link to="/profile" className="flex items-center gap-3 px-4 py-2 rounded-xl hover:bg-gray-800/50 transition-all duration-200 group">
                    ...
                    >
                      <Icon 
                        ...
                        className={`
                          ...
                          ${location.pathname === link.to ? link.color : 'group-hover:text-purple-400'}
                        `} 
                      />
